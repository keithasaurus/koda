...
def test_typed_tuple() -> None:
    ...
    t5: Tuple[int, int, Decimal, bool, List[str]] = \
        typed_tuple(5, 10, Decimal('15.0'), False, ["a", "bc"])
    assert t5 == (5, 10, Decimal('15.0'), False, ["a", "bc"])

    t6: Tuple[int, int, Decimal, bool, List[str], None] = \
        typed_tuple(5, 10, Decimal('15.0'), False, ["a", "bc"], None)
    assert t6 == (5, 10, Decimal('15.0'), False, ["a", "bc"], None)

    t7: Tuple[int, int, Decimal, bool, List[str], None, int] = \
        typed_tuple(5, 10, Decimal('15.0'), False, ["a", "bc"], None, -1)
    assert t7 == (5, 10, Decimal('15.0'), False, ["a", "bc"], None, -1)

    t8: Tuple[int, int, Decimal, bool, List[str], None, int, int] = \
        typed_tuple(5, 10, Decimal('15.0'), False, ["a", "bc"], None, -1, 0)
